...
if __name__ == "__main__":
    ...
    # ////////////////////////////////////////////// pre processing //////////////////////////////////////////////
        ...
        sentences_test = to_lower(sentences_test)
        sentences_train = to_lower(sentences_train)
        #
        # # remove urls
        sentences_test = remove_urls(sentences_test)
        # # exit(1)
        #
        # # remove mentions
        sentences_test = convert_mentions(sentences_test)
        sentences_train = convert_mentions(sentences_train)
        #
        # # remove stop words
        sentences_test = remove_stopwords(sentences_test)
        sentences_train = remove_stopwords(sentences_train)
        #
        # # remove punctuation
        sentences_test = remove_punctuation(sentences_test)
        sentences_train = remove_punctuation(sentences_train)
        ...
        # get longest tweet
        # max_tweet = get_longest_input(sentences_test + sentences_train)
        ...
        sentences_train = pad_sequences(sentences_train, padding='post', maxlen=sentence_len)
        sentences_test = pad_sequences(sentences_test, padding='post', maxlen=sentence_len)
        ...
        grid_result = grid.fit(sentences_train, y_train)

        test_accuracy = grid.score(sentences_test, y_test)
        ...
        # train the model
        history = model.fit(sentences_train, y_train, epochs=50, verbose=True, validation_split = 0.1, batch_size=10)

        # evaluate model
        evaluate_model(model, sentences_train, y_train, sentences_test, y_test)
